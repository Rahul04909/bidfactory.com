<!-- Tender Sourcing & Proposal Development Subscription Component -->
<link rel="stylesheet" href="assets/css/subscription_services.css">
    ...
    <div class="sub-container">
            ...
            <table class="sub-table">
                <thead>
                    <tr>
                        ...
                        <th>Monthly</th>
                        <th>Quarterly</th>
                        <th>Annual (Best Value)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="plan-name" data-label="Plan">Tender Sourcing & Proposal Dev.</td>
                        <td class="plan-coverage" data-label="Coverage">All government departments — State, Central, PSU & Global tenders. Up to 4 proposals/month.</td>
                        <td class="price-val" data-label="Monthly">₹18,999</td>
                        <td class="price-val" data-label="Quarterly">₹48,999</td>
                        <td class="best-value" data-label="Annual (Best Value)">₹1,48,999</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="value-promo">
            ...
            <div class="promo-text">
                ...
                <p>Annual subscription saves approx. 2 months compared to monthly billing. Covers both Indian and global government tenders under a single plan.</p>
            </div>
        </div>
